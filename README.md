...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `41.2µs` | `307.2µs` |
| [Day 2](./src/bin/02.rs) | `52.4µs` | `68.4µs` |
| [Day 3](./src/bin/03.rs) | `144.6µs` | `141.6µs` |
| [Day 4](./src/bin/04.rs) | `157.2µs` | `136.9µs` |
| [Day 5](./src/bin/05.rs) | `22.9µs` | `86.5µs` |
| [Day 6](./src/bin/06.rs) | `-` | `-` |
